...
public class PrototypeFacade
{
    ...
    public static String flightsFromAirlines(String from, String date, int persons) throws MalformedURLException, IOException
    {
        ...
        try
        {
            ...
            String url2 = url1+"api/flightinfo/"+from+ "/" + date + "/" + persons;
